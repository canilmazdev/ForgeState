 ...
 * This file demonstrates how to integrate Forgestate with a web frontend
 */

// For React/Vue/Angular applications
export class ForgestateClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgestateClient(provider, contractAddress);
